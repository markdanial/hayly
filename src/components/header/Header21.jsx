              ...
              <div className="col-auto pe-0 ">
                <div className="d-flex align-items-center">
                  ...
                  <Link
                    ...
                    href="/become-seller"
                  >
                    <span className="d-none d-xl-inline-block">Horses for sale</span>
                  </Link>
                  <Link
                    className={`login-info mx15-lg mx30`}
                    href="/become-seller"
                  >
                    <span className="d-none d-xl-inline-block">Equine services</span>
                  </Link>
                  <Link
                    className={`login-info mx15-lg mx30`}
                    href="/become-seller"
                  >
                    <span className="d-none d-xl-inline-block">Events</span>
                  </Link>
                  <Link
